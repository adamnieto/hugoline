...
* **Example Site** can be found in the [**exampleSite**](https://github.com/adamnieto/hugoline/tree/main/exampleSite) directory. This is what Hugo reads from for the demo site.
